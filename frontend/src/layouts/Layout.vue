            ...
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                <div class="flex h-16 shrink-0 items-center">
                  <img class="h-8 w-auto" src="https://tailwindui.com/plus/img/logos/mark.svg?color=secondary&shade=600"
                       alt="Your Company"/>
                </div>
                  ...
                  <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    ...
                    <li class="mt-auto">
                      <a href="#"
                        ...
                        <Cog6ToothIcon class="size-6 shrink-0 text-gray-400 group-hover:text-secondary-600"
                                       aria-hidden="true"/>
                        Settings
                      </a>
                    </li>
